            ...
            if (ImGui.BeginTabItem("Primitives")) {
                ...
                ImGui.ColorEdit3("Color", col.value);
                {
                    ...
                    for (let n = 0; n < 2; n++) {
                        ...
                        draw_list.AddBezierCurve(new imgui_js_25.ImVec2(x, y), new imgui_js_25.ImVec2(x + sz.value * 1.3, y + sz.value * 0.3), new imgui_js_25.ImVec2(x + sz.value - sz.value * 1.3, y + sz.value - sz.value * 0.3), new imgui_js_25.ImVec2(x + sz.value, y + sz.value), col32, curr_thickness);
                        x = p.x + 4;
                        y += sz.value + spacing;
                    }
